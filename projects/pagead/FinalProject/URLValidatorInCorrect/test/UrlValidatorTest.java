...
//You can use this function to implement your manual testing	   
   ...
   public void testIsValid() {
      ...
      *  but there are a lot of failures so the default is file output */
      ...
      System.out.println("Running programmatic tests over " + cases + " test cases...");
      ...
      System.out.printf("Results-exceptions:%d passes:%d ratio(pass/total):%f", exceptions, passes, ratio);
      try {
         logger.close();
      } catch (IOException e) {
