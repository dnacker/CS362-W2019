...
int buyCard(int supplyPos, struct gameState* state)
{
    ...
    if (state->numBuys < 1) {
        ...
        gainCard(supplyPos, state, 0,
            who); // card goes in discard, this might be wrong.. (2 means goes into hand, 0 goes
                  // into discard)
    ...
    int handPos, int* bonus)
{
    ...
    case minion:
        ...
        else if (choice2) // discard hand, redraw 4, other players with 5+ cards discard hand and
                          // draw 4
        {
            // discard hand
